...
# or generated from the --annotation_file
input_file = '/Users/fof/repenrich_intermediates/repnames.bed'		# don't forget to change this later
if repeat_names_file:
    ...
    print("Generating list of repeats from annotation file, please wait...")
